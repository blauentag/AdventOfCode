defmodule CampCleanup do
  ...
  def fully_contains?(pairs) do
    ...
    (Enum.at(section_0, 0) <= Enum.at(section_1, 0) and
       Enum.at(section_0, 1) >= Enum.at(section_1, 1)) or
      (Enum.at(section_0, 0) >= Enum.at(section_1, 0) and
         Enum.at(section_0, 1) <= Enum.at(section_1, 1))
  end
  ...
  def partially_contains?(pairs) do
    ...
    (Enum.at(section_0, 0) >= Enum.at(section_1, 0) and
       Enum.at(section_0, 0) <= Enum.at(section_1, 1)) or
      (Enum.at(section_0, 1) >= Enum.at(section_1, 0) and
         Enum.at(section_0, 1) <= Enum.at(section_1, 1)) or
      ((Enum.at(section_1, 0) >= Enum.at(section_0, 0) and
          Enum.at(section_1, 0) <= Enum.at(section_0, 1)) or
         (Enum.at(section_1, 1) >= Enum.at(section_0, 0) and
            Enum.at(section_1, 1) <= Enum.at(section_0, 1)))
  end
